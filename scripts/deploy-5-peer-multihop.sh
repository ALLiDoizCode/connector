...
echo -e "${BLUE}[2/6]${NC} Starting 5-peer network..."
echo ""
...
# Step 3: Fund peers from treasury wallet
echo -e "${BLUE}[3/6]${NC} Funding peers from treasury wallet..."
echo ""
...
# Fund each peer
echo "Funding peers with ETH and ERC20 tokens..."
node "${FUNDING_SCRIPT}" \
...
echo -e "${BLUE}[4/6]${NC} Network Topology"
echo ""
...
# Step 5: Send test packet through the network
echo -e "${BLUE}[5/6]${NC} Sending multi-hop test packet..."
echo ""
...
# Step 6: Verify multi-hop routing
echo -e "${BLUE}[6/6]${NC} Verifying multi-hop routing..."
echo ""
