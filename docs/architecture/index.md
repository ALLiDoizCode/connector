...
- [ILP Connector with BTP and Network Visualization - Architecture Document](#table-of-contents)
  ...
  - [Components](./components.md)
    ...
    - [XRPChannelSDK](./components.md#xrpchannelsdk)
    - [UnifiedSettlementExecutor](./components.md#unifiedsettlementexecutor)
    - [XRPChannelLifecycleManager](./components.md#xrpchannellifecyclemanager)
  ...
  - [Core Workflows](./core-workflows.md)
    ...
    - [XRP Settlement Workflow (Dual-Settlement)](./core-workflows.md#xrp-settlement-workflow-dual-settlement)
    - [Dual-Settlement Routing Workflow](./core-workflows.md#dual-settlement-routing-workflow)
