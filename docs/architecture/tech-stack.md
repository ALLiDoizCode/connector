...
| **Nostr Crypto**               | nostr-tools                       | 2.20.0         | Nostr event signing and verification                  | Standard Nostr library, Ed25519/Schnorr signatures, event ID generation. Upgraded from 2.10.0 to fix critical verifyEvent() bug.                      |
