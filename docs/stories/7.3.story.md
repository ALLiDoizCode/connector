...
- [x] Task 2: Add Connector Services to docker-compose-dev.yml (AC: 1, 2, 3, 7, 8, 9)
  ...
  - [ ] Configure hot-reload volumes for connector-alice:
    - [ ] Volumes:
      ...
      - [ ] `./packages/shared/src:/app/node_modules/@m2m/shared/src` (hot-reload shared types)
...
- [x] Task 6: Create Full Stack Integration Test (AC: 10)
  ...
  - [ ] Test 6: "should verify hot-reload volumes are mounted"
    ...
    - [ ] Assert: Volume mount exists for `./packages/shared/src:/app/node_modules/@m2m/shared/src`
...
- **Shared types:** `./packages/shared/src:/app/node_modules/@m2m/shared/src`
...
6. **Hot-Reload Volumes Mounted:**
   ...
   - Verify `./packages/shared/src:/app/node_modules/@m2m/shared/src` mount exists
