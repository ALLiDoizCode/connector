...
| **Reference** | `packages/connector/src/settlement/payment-channel-sdk.ts`   | PaymentChannelSDK — openChannel(), getChannelState(). Imports ChannelState from `@agent-society/shared`                                                                                                  |
