...
.PHONY: help dev-up dev-up-dashboard dev-up-auto-ledger dev-up-all dev-down dev-reset dev-logs dev-logs-connector-alice dev-logs-connector-bob dev-test dev-clean dev-status
